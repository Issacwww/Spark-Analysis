...
public class HitsOnItemRDDnC {
    // part3 task1 & 2 not using cached RDD
    private final static String inputPath = "hdfs:///user/student/input/access_log";
    public static void main(String[] args){

        SparkConf conf = new SparkConf().setAppName("Hits On Item without cache");
